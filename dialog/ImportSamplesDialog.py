...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(477, 196)
        Dialog.setMinimumSize(QtCore.QSize(477, 196))
        Dialog.setMaximumSize(QtCore.QSize(481, 196))
        ...
        icon_LabelImport = join(base_dir, 'settings/icon', 'label_import.png')
        icon.addPixmap(QtGui.QPixmap(icon_LabelImport), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def on_text_changed(self,text):
        ...
        self.lineEdit_labelGSD.setText(result[4])
        ...
        if exists(valset_file):
            with open(valset_file,"r") as f:
                lines = f.readline()
                self.lineEdit_labelValNums.setText(lines)
