...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dockWidget.setMinimumSize(QtCore.QSize(200, 38))
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon/VectorEditor_Edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionSelectSample = QtWidgets.QAction(MainWindow)
        self.actionSelectSample.setCheckable(True)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icon/MarkTool_SelectElement.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSelectSample.setIcon(icon14)
        self.actionSelectSample.setObjectName("actionSelectSample")
        self.actionDeleteSample = QtWidgets.QAction(MainWindow)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icon/VectorEditor_DeleteFeature.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDeleteSample.setIcon(icon15)
        self.actionDeleteSample.setObjectName("actionDeleteSample")
        self.actionMakeSample = QtWidgets.QAction(MainWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icon/label_create.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMakeSample.setIcon(icon16)
        self.actionMakeSample.setObjectName("actionMakeSample")
        self.actionEvalSample = QtWidgets.QAction(MainWindow)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icon/label_eval.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionEvalSample.setIcon(icon17)
        self.actionEvalSample.setObjectName("actionEvalSample")
        self.actionImportSample = QtWidgets.QAction(MainWindow)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icon/label_import1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImportSample.setIcon(icon18)
        self.actionImportSample.setObjectName("actionImportSample")
        self.actionDeleteSamples = QtWidgets.QAction(MainWindow)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icon/label_delete1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDeleteSamples.setIcon(icon19)
        self.actionDeleteSamples.setObjectName("actionDeleteSamples")
        self.actionQuerySample = QtWidgets.QAction(MainWindow)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icon/label_query.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionQuerySample.setIcon(icon20)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/icon/label_close1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCloseSamples.setIcon(icon21)
        self.actionCloseSamples.setObjectName("actionCloseSamples")
        self.actionModelTrain = QtWidgets.QAction(MainWindow)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/icon/Train_Start.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionModelTrain.setIcon(icon22)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/icon/Train_Stop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStopTrain.setIcon(icon23)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/icon/Train_Watch.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionWatchTrain.setIcon(icon24)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/icon/VectorEditor_SelectFeature.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSelectFeature.setIcon(icon25)
        self.actionSelectFeature.setObjectName("actionSelectFeature")
        self.actionDrawRect = QtWidgets.QAction(MainWindow)
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/icon/MarkTool_DrawRectElement.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDrawRect.setIcon(icon26)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/icon/MainCategory_DeleteAllSelect.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionClearDraw.setIcon(icon27)
        self.actionClearDraw.setObjectName("actionClearDraw")
        self.actionSegment = QtWidgets.QAction(MainWindow)
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/icon/Segment.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSegment.setIcon(icon28)
        self.actionSegment.setObjectName("actionSegment")
        self.actionPostClump = QtWidgets.QAction(MainWindow)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/icon/ImgClass_Post_Comb.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPostClump.setIcon(icon29)
        self.actionPostClump.setObjectName("actionPostClump")
        self.actionRasterToVector = QtWidgets.QAction(MainWindow)
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/icon/Utility_RasterToVector.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRasterToVector.setIcon(icon30)
        self.actionRasterToVector.setObjectName("actionRasterToVector")
        self.actionSplitDataSet = QtWidgets.QAction(MainWindow)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/icon/SplitDataset1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSplitDataSet.setIcon(icon31)
        self.actionSplitDataSet.setObjectName("actionSplitDataSet")
        self.actionAbout = QtWidgets.QAction(MainWindow)
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/icon/MainCategory_UserManual.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout.setIcon(icon32)
        self.actionAbout.setObjectName("actionAbout")
        self.actionSampleStatistic = QtWidgets.QAction(MainWindow)
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/icon/label_statistic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSampleStatistic.setIcon(icon33)
        self.actionSampleStatistic.setObjectName("actionSampleStatistic")
        self.actionUpdateDatabase = QtWidgets.QAction(MainWindow)
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/icon/net_update.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUpdateDatabase.setIcon(icon34)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/icon/net_import.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImportModel.setIcon(icon35)
        self.actionImportModel.setObjectName("actionImportModel")
        self.actionDeleteModel = QtWidgets.QAction(MainWindow)
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/icon/net_delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDeleteModel.setIcon(icon36)
        self.actionDeleteModel.setObjectName("actionDeleteModel")
        self.actionModelStatistic = QtWidgets.QAction(MainWindow)
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(":/icon/net_statistic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionModelStatistic.setIcon(icon37)
        self.actionModelStatistic.setObjectName("actionModelStatistic")
        self.actionUpdateModelsDB = QtWidgets.QAction(MainWindow)
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/icon/label_update.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUpdateModelsDB.setIcon(icon38)
        ...
        self.sampleMenu.addAction(self.actionSelectSample)
        ...
        self.processMenu.addAction(self.actionSelectFeature)
        ...
        self.toolBar.addAction(self.actionSelectSample)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于深度学习的遥感影像信息提取系统"))
        ...
        self.dockWidget_2.setWindowTitle(_translate("MainWindow", "样本库列表"))
        ...
        self.actionSelectSample.setText(_translate("MainWindow", "选择要素"))
