...
# Form implementation generated from reading ui file 'LayerAttributeUI.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(638, 425)
        Dialog.setMinimumSize(QtCore.QSize(638, 425))
        Dialog.setMaximumSize(QtCore.QSize(638, 425))
        ...
        self.rasterWHLabel = QtWidgets.QLabel(self.rasterLayerInfoTab)
        self.rasterWHLabel.setObjectName("rasterWHLabel")
        self.horizontalLayout_5.addWidget(self.rasterWHLabel)
        ...
        self.rasterGSDLabel = QtWidgets.QLabel(self.rasterLayerInfoTab)
        self.rasterGSDLabel.setObjectName("rasterGSDLabel")
        self.horizontalLayout_6.addWidget(self.rasterGSDLabel)
        ...
        self.label_2.setMinimumSize(QtCore.QSize(64, 15))
        self.label_2.setMaximumSize(QtCore.QSize(64, 15))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayout_3.addWidget(self.label_2, 0, QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        ...
        self.okPb = QtWidgets.QPushButton(Dialog)
        ...
        self.applyPb = QtWidgets.QPushButton(Dialog)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "图层属性"))
        __sortingEnabled = self.listWidget.isSortingEnabled()
        self.listWidget.setSortingEnabled(False)
        item = self.listWidget.item(0)
        item.setText(_translate("Dialog", "信息"))
        item = self.listWidget.item(1)
        item.setText(_translate("Dialog", "渲染"))
        self.listWidget.setSortingEnabled(__sortingEnabled)
        self.label.setText(_translate("Dialog", "常规信息"))
        self.label_3.setText(_translate("Dialog", "名称"))
        self.rasterNameLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_5.setText(_translate("Dialog", "路径"))
        self.rasterSourceLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_7.setText(_translate("Dialog", "大小"))
        self.rasterMemoryLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_9.setText(_translate("Dialog", "栅格信息"))
        self.label_10.setText(_translate("Dialog", "范围"))
        self.rasterExtentLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_12.setText(_translate("Dialog", "宽和高"))
        self.rasterWHLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_14.setText(_translate("Dialog", "分辨率"))
        self.rasterGSDLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_16.setText(_translate("Dialog", "数据类型"))
        self.rasterDataTypeLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_18.setText(_translate("Dialog", "波段数量"))
        self.rasterBandNumLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_20.setText(_translate("Dialog", "坐标系"))
        self.rasterCrsLabel.setText(_translate("Dialog", "TextLabel"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.rasterLayerInfoTab), _translate("Dialog", "rasterLayerInfoTab"))
        self.label_26.setText(_translate("Dialog", "常规信息"))
        self.label_25.setText(_translate("Dialog", "名称"))
        self.vectorNameLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_32.setText(_translate("Dialog", "路径"))
        self.vectorSourceLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_30.setText(_translate("Dialog", "大小合计"))
        self.vectorMemoryLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_34.setText(_translate("Dialog", "矢量信息"))
        self.label_27.setText(_translate("Dialog", "范围"))
        self.vectorExtentLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_33.setText(_translate("Dialog", "几何图形"))
        self.vectorGeoTypeLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_31.setText(_translate("Dialog", "要素总数"))
        self.vectorFeatureNumLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_35.setText(_translate("Dialog", "编码"))
        self.vectorEncodingLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_28.setText(_translate("Dialog", "坐标系"))
        self.vectorCrsLabel.setText(_translate("Dialog", "TextLabel"))
        self.label_29.setText(_translate("Dialog", "数据源"))
        self.vectorDpLabel.setText(_translate("Dialog", "TextLabel"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.vectorLayerInfoTab), _translate("Dialog", "vectorLayerInfoTab"))
        self.label_2.setText(_translate("Dialog", "图层渲染"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.rasterLayerRenderTab), _translate("Dialog", "rasterLayerRenderTab"))
        self.label_36.setText(_translate("Dialog", "图层渲染"))
        self.vecterRenderCB.setItemText(0, _translate("Dialog", "单一渲染"))
        self.vecterRenderCB.setItemText(1, _translate("Dialog", "分类渲染"))
        self.comboTabWidget.setTabText(self.comboTabWidget.indexOf(self.singleRender), _translate("Dialog", "Tab 1"))
        self.comboTabWidget.setTabText(self.comboTabWidget.indexOf(self.categoryRender), _translate("Dialog", "Tab 2"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.vectorLayerRenderTab), _translate("Dialog", "vectorLayerRenderTab"))
        self.okPb.setText(_translate("Dialog", "确认"))
        self.cancelPb.setText(_translate("Dialog", "取消"))
        self.applyPb.setText(_translate("Dialog", "应用"))
